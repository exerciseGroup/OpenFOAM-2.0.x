...
// add by NUDT Exercise Group-RXG: begin
    lduSmoother::addsymMatrixConstructorToTableAppend<iluSmoother>
        addiluSmootherSymMatrixConstructorToTableAppend_;
    
    lduSmoother::addasymMatrixConstructorToTableAppend<iluSmoother>
        addiluSmootherAsymMatrixConstructorToTableAppend_;
