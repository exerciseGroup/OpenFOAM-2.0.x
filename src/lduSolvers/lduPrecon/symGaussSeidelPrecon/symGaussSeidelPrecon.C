...
//add by NUDT Exercise Group-Xiaowei:begin
    ...
    lduPreconditioner::
        addsymMatrixConstructorToTableAppend<symGaussSeidelPrecon>
        addsymGaussSeidelPreconditionerSymMatrixConstructorToTable_1;

    lduPreconditioner::
        addasymMatrixConstructorToTableAppend<symGaussSeidelPrecon>
        addsymGaussSeidelPreconditionerAsymMatrixConstructorToTable_1;
