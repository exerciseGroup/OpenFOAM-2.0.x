...
//add by NUDT Exercise Group-Xiaowei:begin
    lduPreconditioner::
        addsymMatrixConstructorToTableAppend<amgPrecon>
        addamgPreconditionerSymMatrixConstructorToTableAppend_;

    lduPreconditioner::
        addasymMatrixConstructorToTableAppend<amgPrecon>
        addamgPreconditionerAsymMatrixConstructorToTableAppend_;
